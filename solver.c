...
void print_cube_3_state(cube_3_state_t st) {
    ...
    printf("%c%c%c%c%c%c%c%c%c\n", ctc(st, 6, 1), '-', ctc(st, 2, 2), ctc(st, 2, 0), '-', ctc(st, 3, 0), ctc(st, 3, 1), '-', ctc(st, 7, 2));
    printf("%c%c%c%c%c%c%c%c%c\n", '-', 'G', '-', '-', 'W', '-', '-', 'B', '-');
    printf("%c%c%c%c%c%c%c%c%c\n", ctc(st, 4, 2), '-', ctc(st, 0, 1), ctc(st, 0, 0), '-', ctc(st, 1, 0), ctc(st, 1, 2), '-', ctc(st, 5, 1));
    printf("   %c%c%c   \n", ctc(st, 0, 2), '-', ctc(st, 1, 1));
    printf("   %c%c%c   \n", '-', 'R', '-');
